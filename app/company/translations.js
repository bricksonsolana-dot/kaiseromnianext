const translations = {
    el: {
      ...
      stats: {
        badge: '04 — Αριθμοί',
        title: 'Η Kaiser Omnia σε Αριθμούς',
        items: [
          { value: '40+',  label: 'Χρόνια Λειτουργίας' },
          { value: '280+', label: 'Ολοκληρωμένα Έργα' },
          { value: '150+', label: 'Μηχανικοί & Τεχνικοί' },
      ...
      // ── 05 Certifications ─────────────────────────────────────────
      certifications: {
        badge: '05 — Πιστοποιήσεις',
        title: 'Πιστοποιήσεις & Βραβεία',
        items: [
          { name: 'ISO 9001:2015',  desc: 'Σύστημα Διαχείρισης Ποιότητας' },
          { name: 'ISO 14001:2015', desc: 'Σύστημα Περιβαλλοντικής Διαχείρισης' },
          { name: 'CE Marking',     desc: 'Ευρωπαϊκή Πιστοποίηση Προϊόντων' },
          { name: 'ELOT EN 1090',   desc: 'Πιστοποίηση Μεταλλικών Κατασκευών' },
          { name: 'ΕΛΟΤ 1501',      desc: 'Ελληνικό Πρότυπο Ποιότητας' },
          { name: 'Green Building', desc: 'Πιστοποίηση Πράσινων Κατασκευών' },
        ],
      },
    ...
    en: {
      ...
      stats: {
        badge: '04 — Numbers',
        title: 'Kaiser Omnia in Numbers',
        items: [
          { value: '40+',  label: 'Years of Operation' },
          { value: '280+', label: 'Completed Projects' },
          { value: '150+', label: 'Engineers & Technicians' },
          { value: '100%', label: 'Client Satisfaction' },
        ],
      },
  
      certifications: {
        badge: '05 — Certifications',
        title: 'Certifications & Awards',
        items: [
          { name: 'ISO 9001:2015',  desc: 'Quality Management System' },
          { name: 'ISO 14001:2015', desc: 'Environmental Management System' },
          { name: 'CE Marking',     desc: 'European Product Certification' },
          { name: 'ELOT EN 1090',   desc: 'Steel Structure Certification' },
          { name: 'ΕΛΟΤ 1501',      desc: 'Greek Quality Standard' },
          { name: 'Green Building', desc: 'Green Construction Certification' },
        ],
      },
