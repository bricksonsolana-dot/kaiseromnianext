const translations = {
    el: {
      ...
      services: [
        ...
        {
          num: '02', total: '04',
          title: 'Τεχνικός Σχεδιασμός Εφαρμογής',
          desc: 'Ο τεχνικός σχεδιασμός αποτελεί το κρίσιμο στάδιο όπου η μελέτη μετατρέπεται σε υλοποιήσιμη κατασκευή. Με ακρίβεια και πλήρη συντονισμό, διασφαλίζεται η σωστή εφαρμογή κάθε λεπτομέρειας, μειώνοντας αστοχίες και εξαλείφοντας αποκλίσεις κατά την εκτέλεση του έργου.',
        },
        {
          num: '03', total: '04',
          title: 'Κατασκευή',
          desc: 'Η εξειδίκευση στο σύστημα double wall γερμανικής προέλευσης αποτελεί τη βάση της κατασκευαστικής μας φιλοσοφίας, προσφέροντας βιομηχανική ακρίβεια και αυξημένη αντισεισμική θωράκιση. Ένα σύστημα που αναβαθμίζει το επίπεδο ποιότητας και αξιοπιστίας της σύγχρονης κατασκευής.',
        },
        {
          num: '04', total: '04',
          title: 'Διαχείριση Έργου',
          desc: 'Η διαχείριση έργου εξασφαλίζει τον πλήρη συντονισμό και έλεγχο κάθε φάσης της κατασκευής, με στόχο την ομαλή εξέλιξη του έργου χωρίς καθυστερήσεις ή αποκλίσεις. Μέσα από συνεχή επίβλεψη, σωστή οργάνωση συνεργείων και αυστηρό ποιοτικό έλεγχο, διασφαλίζεται η συνέπεια στο χρονοδιάγραμμα, ο έλεγχος κόστους και η υψηλή ποιότητα στο τελικό αποτέλεσμα.',
        },
      ],
      ...
      advantages: {
        ...
        items: [
          {
            title: 'Αντισεισμική Θωράκιση',
            desc: 'Η κατασκευή βασίζεται σε πλήρως μονολιθικό φέροντα οργανισμό από οπλισμένο σκυρόδεμα. Η συνεχής σύνδεση των δομικών στοιχείων εξασφαλίζει υψηλή δομική αντοχή και πλήρη συμμόρφωση με τους σύγχρονους αντισεισμικούς κανονισμούς.',
          },
          {
            title: 'Μονολιθική Δομή Σκυροδέματος',
            desc: 'Το σκυρόδεμα του φέροντος οργανισμού χύνεται επιτόπου, δημιουργώντας μια ενιαία και συμπαγή δομή από οπλισμένο σκυρόδεμα χωρίς ασυνέχειες.',
          },
          {
            title: 'Θερμική και Ηχητική Απόδοση',
            desc: 'Η σύνθεση των διπλών τοιχωμάτων συμβάλλει στη βελτίωση της θερμομονωτικής και ηχομονωτικής συμπεριφοράς του κτιρίου, δημιουργώντας πιο άνετους και ενεργειακά αποδοτικούς εσωτερικούς χώρους.',
          },
          {
            title: 'Ταχύτερη Εξέλιξη Έργου',
            desc: 'Η οργανωμένη διαδικασία κατασκευής επιτρέπει σημαντική επιτάχυνση του χρονοδιαγράμματος, οδηγώντας σε έως 40% ταχύτερη εξέλιξη του έργου σε σχέση με συμβατικές μεθόδους κατασκευής.',
          },
          {
            title: 'Υψηλή Κατασκευαστική Ακρίβεια',
            desc: 'Η υψηλή γεωμετρική ακρίβεια των δομικών στοιχείων εξασφαλίζει σωστή ευθυγράμμιση των τοιχωμάτων και καθαρή γεωμετρία της κατασκευής. Με τον τρόπο αυτό αποφεύγονται διορθωτικές παρεμβάσεις στα επόμενα στάδια.',
          },
          {
            title: 'Οικολογικό Αποτύπωμα',
            desc: '30% λιγότερα απόβλητα κατασκευής, χρήση ανακυκλώσιμων υλικών και μειωμένη ενεργειακή κατανάλωση κατά την παραγωγή.',
          },
        ],
      },
      ...
      comparison: {
        ...
        headers: {
          ...
          doubleWall: 'Διπλοί Τοίχοι Kaiser Omnia',
        },
        rows: [
    ...
    en: {
        ...
        items: [
          {
            ...
            desc: 'The construction is based on a fully monolithic load-bearing structure of reinforced concrete. The continuous connection of structural elements ensures high structural strength and full compliance with modern seismic regulations.',
          },
          {
            title: 'Monolithic Concrete Structure',
            desc: 'The concrete of the load-bearing structure is poured in situ, creating a unified and solid reinforced concrete structure without discontinuities.',
          },
          {
            title: 'Thermal & Acoustic Performance',
            desc: 'The composition of the double walls contributes to improved thermal insulation and soundproofing performance of the building, creating more comfortable and energy-efficient interior spaces.',
          },
          {
            title: 'Faster Project Progress',
            desc: 'The organised construction process allows significant acceleration of the schedule, leading to up to 40% faster project progress compared to conventional construction methods.',
          },
          {
            title: 'High Construction Precision',
            desc: 'The high geometric precision of structural elements ensures correct alignment of walls and clean construction geometry. This eliminates corrective interventions and construction patch-ups in subsequent stages.',
          },
          {
            title: 'Ecological Footprint',
            desc: '30% less construction waste, use of recyclable materials and reduced energy consumption during production.',
          },
        ],
      },
      ...
      comparison: {
        ...
        headers: {
          ...
          doubleWall: 'Kaiser Omnia Double Walls',
        },
        rows: [
